...
int main( void )
{
	...
	std::cout << "size of === " << std::numeric_limits<size_t>::max() / sizeof(int) << std::endl;
	std::cout << "size of === " << std::numeric_limits<size_t>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<char>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<wchar_t>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<signed char>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<short int>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<int>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<long int>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<unsigned char>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<unsigned short int>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<unsigned int>::max() << std::endl;
	std::cout << "size of === " << std::numeric_limits<unsigned long int>::max() << std::endl;
	...
	try
	{
		ft::vector<int> boolv2((std::numeric_limits<int>::max(), 0));
	}
	catch(const std::exception& e)
	{
		std::cout << CYAN << "ERRRRRROOOOR" << NORMAL << std::endl;
